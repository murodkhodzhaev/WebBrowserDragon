...
internal class TrackerDatabaseHelper(context: Context?) :
    ...
    companion object {
        ...
        private const val SQL_CREATE_ENTRIES =
            "CREATE TABLE IF NOT EXISTS " + web.browser.dragon.huawei.utils.appsflyer.AdmitadTrackerContract.TrackEntry.TABLE_NAME + " (" +
                    web.browser.dragon.huawei.utils.appsflyer.AdmitadTrackerContract.TrackEntry.COLUMN_NAME_TYPE + " INTEGER PRIMARY KEY AUTOINCREMENT," +
