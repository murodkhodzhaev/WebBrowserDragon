...
class TrackerControllerImpl internal constructor(
    ...
    private val databaseRepository: web.browser.dragon.utils.appsflyer.DatabaseRepository
    private val networkRepository: web.browser.dragon.utils.appsflyer.NetworkRepository
